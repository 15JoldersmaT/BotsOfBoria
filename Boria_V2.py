...
class Bot:
    def __init__(self, x, y, color, contagious, conColor, conChance, conDist):
        self.x = x
        self.y = y
        self.color = color
...
for _ in range(pinkBots + yellowBots + greenBots + blueBots + orangeBots + cyanBots + redBots):
    bot = Bot(random.randint(1, 1300), random.randint(1, 800), random.choice([(247, 114, 187),(255, 0, 0), (215, 215, 18), (0, 255, 0), (0, 0, 255), (200, 55, 187), (0, 255, 255)]),False, (255,0,0),10,1)
    ...
    if keys[pygame.K_r]:
        ...
        for _ in range(215):
            if cBots == 1 :
                ...
                bot = Bot(random.randint(1, 1300), random.randint(1, 800), random.choice([(247, 114, 187),(255, 0, 0), (215, 215, 18)]),False,(0, 255, 255), 10,1)
            elif cBots == 4:
                bot = Bot(random.randint(1, 1300), random.randint(1, 800), random.choice([(247, 114, 187),(255, 0, 0), (215, 215, 18), (0, 255, 0)]),False,(0, 255, 255), 10,1)
            elif cBots == 5:
                bot = Bot(random.randint(1, 1300), random.randint(1, 800), random.choice([(247, 114, 187),(255, 0, 0), (215, 215, 18), (0, 255, 0), (0, 0, 255), (200, 55, 187)]),False,(0, 255, 255), 10,1)
